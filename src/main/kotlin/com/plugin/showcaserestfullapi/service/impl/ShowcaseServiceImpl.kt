...
//        validationUtil.validate(createShowcaseRequest)
    ...
    override fun put(id: Int, updateShowcaseRequest: CreateShowcaseRequest): ShowcaseResponse {
        val showcase = showcaseRepository.findByIdOrNull(id)
        if (showcase === null) {
            throw NotFoundException()
        }
        showcase.apply {
            val title = updateShowcaseRequest.title!!
            val description = updateShowcaseRequest.description!!
            val updatedAt = Date()
